...
import 'package:repaid_loan/util/dio_util/dio_cache_interceptors.dart';
import 'package:repaid_loan/util/dio_util/dio_interceptors.dart';
import 'package:repaid_loan/util/dio_util/dio_method.dart';
import 'package:repaid_loan/util/dio_util/dio_transformer.dart';
...
class DioUtil {
  ...
  /// 统一 url 前缀
  static const String BASE_URL = 'http://8.215.46.156:1060/';
